...
app = Flask(__name__)
app.secret_key = 'your_secret_key'  # Change to a secure key for production
...
main_model = load_model(r"C:\Users\Admin\Downloads\project\models\best_model_xception_main (1).keras")  
stage_model = load_model(r"C:\Users\Admin\Downloads\project\models\model_xception_stage.keras")  

# Class labels for predictions
main_classes = ['Not Infected', 'Infected']
stage_classes = ['falciparum', 'vivax', 'ovale', 'malariae']
